...
public interface SweetPotatoRepository extends JpaRepository<SweetPotato, Long> {
    ...
    // Save a batch of SweetPotato entries
    @Modifying
    ...
    // Save a single SweetPotato entry and delete the oldest one
    ...
    List<SweetPotato> findByGradeOrderByYearAscMonthAscDayAsc(Grade grade);
}